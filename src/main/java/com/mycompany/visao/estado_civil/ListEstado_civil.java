 ...
 public void listarTodos(){
    ...
    private void tableEstado_civilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableEstado_civilMouseClicked
        ...
        if (evt.getClickCount() == 2){
            ModEstado_civil modCidade = new ModEstado_civil();

            modCidade.setId(Integer.parseInt(String.valueOf(tableEstado_civil.getValueAt(tableEstado_civil.getSelectedRow(), 0))));
            modCidade.setNome(String.valueOf(tableEstado_civil.getValueAt(tableEstado_civil.getSelectedRow(), 1)));

            DadosTemporarios.tempObject = (ModEstado_civil) modCidade;
